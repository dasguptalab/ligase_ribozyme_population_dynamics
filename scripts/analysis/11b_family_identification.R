...
seqs_input <- read.csv("/Users/bamflappy/PfrenderLab/RNA_evolution/outputs/09b_quantified_above2/counts_plot_table_noDoped.RC.csv", colClasses=c("run_name"="character", "counts_run_name"="character"))

...
r8_peaks <- read.csv("/Users/bamflappy/PfrenderLab/RNA_evolution/outputs/08_summarized_1400_above2/r8_S8_L001_cluster_peaks_table.csv")
...
# export data
write.csv(seqs_data, file = paste(out_dir, "/family_identities_1400_above2.csv", sep = ""), row.names = FALSE, quote = FALSE)
...
# export data
write.csv(seqs_out, file = paste(out_dir, "/family_identities_atLeast90_1400_above2.csv", sep = ""), row.names = FALSE, quote = FALSE)

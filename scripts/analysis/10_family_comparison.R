...
# export data
write.csv(seqs_data, file = paste(out_dir, "/family_identities_1500_above2.csv", sep = ""), row.names = FALSE, quote = FALSE)
...
# export data
write.csv(seqs_out, file = paste(out_dir, "/family_identities_atLeast90_1500_above2.csv", sep = ""), row.names = FALSE, quote = FALSE)

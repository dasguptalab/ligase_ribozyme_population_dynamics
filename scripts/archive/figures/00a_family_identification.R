...
out_dir <- "/Users/bamflappy/PfrenderLab/RNA_evolution/outputs/figures/00a_family_identification"

# create outputs directory
dir.create(out_dir, showWarnings = FALSE)

# read in cluster family sequence data
r8_peaks <- read.csv("/Users/bamflappy/PfrenderLab/RNA_evolution/outputs/08_summarized/07a_clustered/r8_S8_L001_formatted_cluster_peaks_table.csv")

# read in sequence count data
seqs_input <- read.csv("/Users/bamflappy/PfrenderLab/RNA_evolution/outputs/11_quantified/counts_plot_table_noDoped.csv", colClasses=c("run_name"="character", "counts_run_name"="character"))

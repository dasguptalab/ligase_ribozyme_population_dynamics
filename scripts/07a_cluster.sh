...
# usage ex: qsub 07a_cluster.sh /scratch365/ebrooks5/RNA_evolution/outputs_flash/06_formatted/r8_S8_L001_formatted.fa
# usage ex: fileList=(/scratch365/ebrooks5/RNA_evolution/outputs_flash/06_formatted/*_above9); for ((i=${#fileList[@]}-1; i>=0; i--)); do qsub 07a_cluster.sh "${fileList[$i]}"; done
# alternate usage: bash 07a_cluster.sh inputFile
# usage ex: bash 07a_cluster.sh /scratch365/ebrooks5/RNA_evolution/outputs_flash/06_formatted/r8_S8_L001_formatted_above9.fa
# usage ex: bash 07a_cluster.sh /scratch365/ebrooks5/RNA_evolution/outputs_flash/06_formatted/r7_S7_L001_formatted_above9.fa
# usage ex: bash 07a_cluster.sh /scratch365/ebrooks5/RNA_evolution/outputs_flash/06_formatted/r6_S6_L001_formatted_above9.fa

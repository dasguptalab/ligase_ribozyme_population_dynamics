...
out_dir <- "/Users/bamflappy/PfrenderLab/RNA_evolution/outputs/figures/00a_family_identification_above9"
...
# export data
write.csv(seqs_data, file = paste(out_dir, "/family_identities_above9.csv", sep = ""), row.names = FALSE, quote = FALSE)
...
# export data
write.csv(seqs_out, file = paste(out_dir, "/family_identities_above9_atLeast90.csv", sep = ""), row.names = FALSE, quote = FALSE)
